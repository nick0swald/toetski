...
export const VOORBEELD_NASK_LESSTOF = `Lesstof klas 2 KB NaSk — Temperatuur, warmte en meten
Aeres VMBO Leeuwarden, praktijkkas.
...
const vragen: GegenereerdeToets["vragen"] = [
  ...
  },
  {
    ...
    punten: 3,
    context:
      "Leerlingen van klas 2 KB zetten twee even grote basilicumplantjes in de praktijklokalen. Plant A krijgt een plek bij het raam. Plant B zetten ze in een donkere kast. Beide planten krijgen evenveel water.",
  ...
  },
  {
    ...
    punten: 3,
    context:
      "Tabel 1 – CO₂-gehalte in een oefenkas (gemiddelde van drie metingen)\n\nTijdstip | CO₂ (ppm)\n07:00 | 620\n12:00 | 410\n19:00 | 480\n23:00 | 590",
  ...
  },
  {
    ...
    punten: 4,
    context:
      "Bron 1 – CO₂-verloop in de oefenkas van Aeres (één etmaal, geen extra belichting).",
  ...
  },
  {
    ...
    punten: 4,
    context:
      "In januari is de kas 20 °C, maar er is weinig daglicht. Een collega overweegt extra belichting.",
...
const nakijkmodel: GegenereerdeToets["nakijkmodel"] = [
  {
    nummer: 1,
    modelantwoord:
      "Fotosynthese is het proces waarbij groene planten met water, CO₂ en licht glucose (suiker) en zuurstof maken.",
    puntenverdeling: [
      { punt: 1, criterium: "noemt glucose / suiker / voedsel maken" },
      { punt: 1, criterium: "noemt licht en/of CO₂ / water als voorwaarde, of zuurstof als product" },
    ],
  },
  {
    nummer: 2,
    ...
    puntenverdeling: [
      ...
      { punt: 1, criterium: "licht (energie)" },
  ...
  },
  {
    nummer: 3,
    modelantwoord: "B",
    puntenverdeling: [{ punt: 1, criterium: "B — bladgroenkorrel / chloroplast" }],
  },
  {
    nummer: 4,
    modelantwoord: "B",
    puntenverdeling: [{ punt: 1, criterium: "B — huidmondjes" }],
  },
  {
    nummer: 5,
    modelantwoord:
      "a. glucose (suiker) en zuurstof.\nb. Zonder licht kan er geen fotosynthese plaatsvinden; licht levert de energie voor het proces.",
    puntenverdeling: [
      { punt: 1, criterium: "a. glucose / suiker / zetmeel" },
  ...
  },
  {
    nummer: 7,
    modelantwoord:
      "’s Nachts is er geen licht, dus geen (netto) fotosynthese. De plant blijft wel dissimileren (celademhaling): glucose + zuurstof → energie + CO₂ + water. Daardoor stijgt het CO₂-gehalte. De plant leeft omdat hij van zijn glucosevoorraad teert.",
    puntenverdeling: [
      { punt: 1, criterium: "geen / weinig fotosynthese ’s nachts (geen licht)" },
      { punt: 1, criterium: "dissimilatie / celademhaling gaat door" },
  ...
  },
  {
    nummer: 8,
    modelantwoord:
      "a. In januari is er weinig licht; zonder licht weinig fotosynthese, dus weinig groei, ook bij 20 °C.\nb. Voordeel: meer fotosynthese / hogere opbrengst / kortere teeltduur. Nadeel: energiekosten / hogere CO₂-voetafdruk / ongelijke groei bij verkeerd spectrum.",
    puntenverdeling: [
      { punt: 1, criterium: "a. noemt tekort aan licht in januari" },
      { punt: 1, criterium: "a. koppelt licht aan fotosynthese / groei" },
      { punt: 1, criterium: "b. een juist voordeel" },
      { punt: 1, criterium: "b. een juist nadeel" },
    ],
  },
  {
    nummer: 9,
  ...
  },
  {
    nummer: 10,
    modelantwoord:
      "Planten maken via fotosynthese glucose én zuurstof. Mensen (en dieren) gebruiken die glucose als voedsel en de zuurstof bij ademhaling. Bij ademhaling komt CO₂ vrij, die planten weer gebruiken. Zonder planten geen (duurzame) zuurstof en geen voedsel; zonder CO₂ van ademhaling/verbranding verloopt fotosynthese moeizamer. Het is een kringloop, geen eenrichtingsverkeer van alleen zuurstof.",
    puntenverdeling: [
      { punt: 1, criterium: "planten maken glucose (voedsel) én zuurstof" },
      { punt: 1, criterium: "mensen gebruiken zuurstof én (plantaardige) glucose" },
      { punt: 1, criterium: "mensen/dieren leveren CO₂ terug" },
      { punt: 1, criterium: "beschrijft onderlinge afhankelijkheid / kringloop" },
    ],
  },
];
...
export function maakVoorbeeldToets(): GegenereerdeToets {
  ...
  return {
    ...
    bronmateriaal:
      "Lesstof klas 2 KB biologie: fotosynthese, dissimilatie, huidmondjes, chloroplasten. Praktijkkas Aeres.",
    ...
    kwaliteit: {
      samenvatting:
        "Evenwichtige onderbouwtoets met groene Aeres-context (kas, tomaat, basilicum). RTTI ligt dicht tegen de onderbouwnorm. Geschikt als sectievoorbeeld; altijd zelf vakinhoudelijk nalopen.",
      punten: [
        {
          criterium: "Validiteit",
          oordeel: "voldoet",
          toelichting:
            "Dekking van kerndoelen fotosynthese, gaswisseling en dissimilatie; contexten sluiten aan op de groene praktijk.",
        },
        {
          criterium: "Betrouwbaarheid / nakijkmodel",
          oordeel: "voldoet",
          toelichting:
            "Puntenverdeelsleutel per vraag, inclusief wat níét scoort. Twee beoordelaars kunnen daarmee tot dezelfde score komen.",
        },
        {
          criterium: "RTTI-spreiding",
          oordeel: "voldoet",
          toelichting:
            "R 22% · T1 33% · T2 30% · I 15% van de punten. Iets meer transfer/inzicht dan de onderbouwdoelstelling — acceptabel, eventueel vraag 10 inkorten.",
        },
        {
          criterium: "Taal (VMBO KB)",
          oordeel: "voldoet",
          toelichting:
            "Korte zinnen, bekende woorden, contexten uit de eigen kas. Geen dubbele ontkenningen.",
        },
        {
          criterium: "Transparantie",
          oordeel: "voldoet",
          toelichting:
            "Punten staan per vraag en in de instructie. Maximumscore 27 is op het voorblad vermeld.",
        },
        {
          criterium: "Cito-opmaak",
          oordeel: "voldoet",
          toelichting:
            "Nummering, punten in de kantlijn, meerkeuze A–D, instructies op het voorblad.",
        },
      ],
    },
  };
...
export function maakVoorbeeldNaskToets(): GegenereerdeToets {
  const naskVragen: GegenereerdeToets["vragen"] = [
    {
      nummer: 1,
      type: "open",
      rtti: "R",
    ...
    },
    {
      ...
      grafiek: naskGrafiek,
      opties: [
        { letter: "A", tekst: "10 min" },
        { letter: "B", tekst: "20 min" },
        { letter: "C", tekst: "30 min" },
        { letter: "D", tekst: "40 min" },
      ],
    },
    {
      nummer: 4,
      ...
      punten: 4,
      context:
        "Een emmer met 2,0 kg water staat in dezelfde kas. c = 4,2 kJ/(kg·°C). ΔT is de stijging uit de tabel van t = 0 tot t = 40 min.",
  ...
  return {
    ...
    nakijkmodel: [
      {
        ...
        puntenverdeling: [{ punt: 1, criterium: "°C of graden Celsius" }],
      },
      {
        nummer: 2,
        modelantwoord: "a. 24,0 °C. b. 26,0 − 18,0 = 8,0 °C.",
        puntenverdeling: [
          { punt: 1, criterium: "a. 24,0 (of 24) °C" },
          { punt: 1, criterium: "b. 8,0 (of 8) °C" },
        ],
      },
      {
        nummer: 3,
        modelantwoord: "B",
        puntenverdeling: [{ punt: 1, criterium: "B — 20 min" }],
      },
      {
        nummer: 4,
        modelantwoord: "ΔT = 8,0 °C. Q = 2,0 × 4,2 × 8,0 = 67 kJ (2 s.c.).",
        puntenverdeling: [
          { punt: 1, criterium: "ΔT = 8,0 °C" },
          { punt: 1, criterium: "invullen Q = m c ΔT" },
          { punt: 1, criterium: "67 (kJ) of 6,7·10^4 J" },
          { punt: 1, criterium: "eenheid kJ of J" },
        ],
      },
      {
        nummer: 5,
        modelantwoord: "18,0 °C ± 0,5 °C",
        puntenverdeling: [{ punt: 1, criterium: "18,0 met ±0,5 °C" }],
      },
      {
        nummer: 6,
        modelantwoord:
          "De kas nadert een evenwicht: evenveel warmte erbij als eraf (ventilatie, straling). Daardoor stijgt T steeds minder.",
        puntenverdeling: [
          { punt: 1, criterium: "noemt evenwicht of evenveel erbij als eraf" },
          { punt: 1, criterium: "koppelt aan afvlakken van de grafiek" },
          { punt: 1, criterium: "noemt een oorzaak (ventilatie/straling/verlies)" },
        ],
      },
    ],
    cesuur: {
    ...
    matrijs: bouwMatrijs(naskVragen, doelverdeling),
    kwaliteit: {
      samenvatting:
        "NaSk-voorbeeld met echte tabel en grafiek, formule Q = m c ΔT, eenheden en meetonzekerheid. Constructiehulp — altijd zelf nalopen.",
      punten: [
        {
